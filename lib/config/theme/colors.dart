...
abstract class AppColor {
  ...
  static const Color bottomNavigationBarLight = Color(0xFF2261C0);
  static const Color primaryLight = Color(0xFF4B8EFF);
  static const Color onPrimaryLight = Color(0xFFFFFFFF);
  static const Color secondaryLight = Color(0xFF2261C0);

  static const Color secondaryLight2 = Color(0xFFE0E2E4);
